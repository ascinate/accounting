            ...
            <div class="form-section">
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" name="tax" class="form-control" value="{{ $purchase->tax }}">
                    </div>
                    <div class="col-md-4 mb-3">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" name="shipping" class="form-control" value="{{ $purchase->shipping }}">
                    </div>
                    <div class="col-12 mb-3">
                        <label class="form-label">Other Details</label>
                        <textarea name="other_details" class="form-control" rows="2">{{ $purchase->other_details }}</textarea>
                    </div>
                </div>
            </div>
