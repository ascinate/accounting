        ...
        <div class="row">
          ...
          <div class="col-lg-7 col-md-7 col-6">
            ...
            <div class="header-right">
              ...
              <a href="{{ URL::to('/pos') }}" class="btn btn-outline-primary fw-bolder">
              POS
              </a>
              ...
              <div class="profile-box ml-15">
                ...
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="profile">
                  ...
                  <li>
                    <a class="nav-link" href="#" data-bs-toggle="modal" data-bs-target="#changeUserPasswordModal">
                  ...
                  <li>
                    ...
                    <a href="{{ URL::to('/logout') }}"> <i class="lni lni-exit"></i> Sign Out </a>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form id="user-change-password-form">
              @csrf
              <div class="mb-3">
                <input type="password" name="new_password" id="user_new_password" class="form-control" placeholder="Enter New Password" required>
              </div>
              <div id="user-response-message" class="text-center"></div>
