                    ...
                    <table id="example" class="table-wrapper table table-striped nowrap" style="width:100%">
                      ...
                      @foreach($suppliers as $supplier)
                        <tr>
                          ...
                          <td>
                            <div class="action">
                            <a href="{{ URL::to('deletesuppliers', $supplier->id) }}" class="text-danger"  onclick="return confirm('Are you sure you want to delete this Supplier?')">
