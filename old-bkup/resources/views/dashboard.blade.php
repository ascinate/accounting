      ...
      <div class="col-lg-4 col-md-12">
        <div class="card mb-4">
          <div class="card-body">
            ...
            <div id="echart_Top_products" style="-webkit-tap-highlight-color: transparent; user-select: none; position: relative;" _echarts_instance_="ec_1745394533058"><div style="position: relative; overflow: hidden; width: 319px; height: 300px; padding: 0px; margin: 0px; border-width: 0px;"><canvas data-zr-dom-id="zr_0" width="319" height="300" style="position: absolute; left: 0px; top: 0px; width: 319px; height: 300px; user-select: none; -webkit-tap-highlight-color: rgba(0, 0, 0, 0); padding: 0px; margin: 0px; border-width: 0px;"></canvas></div><div></div></div>
          </div>
        </div>
      </div>
    </div>
